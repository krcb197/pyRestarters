...
@_attrs_define
class GroupStats:
    """An array of statistics about the activity of a group.
    ...
    Attributes:
        ...
        hours_volunteered (float | Unset): The estimated number of hours volunteered for this group.
        events (float | Unset): The number of events created by this group.
    """
