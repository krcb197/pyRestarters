...
class Statistics:
    """
    Data class to hold the Statistics generated by Restarters.net
    """
    # this dataclass has to mirror the statistics generated by restarters
    ...
    def __add__(self, other: Self) -> 'Statistics':
        if not isinstance(other, Statistics):
            raise NotImplementedError('It is only possible to combine two '
                                      f'Statisics instances, got type: {type(other)}')
